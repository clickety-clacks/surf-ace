...
export function createSurfAceTools(runtime: SurfAceRuntime): SurfAceToolDefinition<any>[] {
  return [
    ...
    {
      description: "Launch a provider-owned native app/process target in a pane through Surf Ace native hosting. This is the primitive process launch surface. Requires confirmed:true.",
