...
- `surf_ace_list`: local-only. Returns surfaces, connection state, panes, active content, and pending provider-side events.
...
3. Use `surf_ace_read` for annotation interpretation. Do not expect it to make a live network call.
